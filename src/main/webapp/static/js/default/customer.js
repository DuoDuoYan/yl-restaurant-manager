$().ready(function() {
    ...
    //数据校验
    validator($('#addCustomerForm'));
    validator($('#updateCustomerForm'));
...
function init(){
    ...
    $('#dataTable').bootstrapTable({
        ...
        url : "/restaurant/findAllCustomer", // 服务器数据的加载地址
        iconSize : 'outline',
...
function  btnFunction() {
    ...
    $('#addCustomerBtn').click(function () {
        ...
        //验证输入数据结果
        if($('#addCustomerForm').data('bootstrapValidator').isValid()){
            $.ajax({
                method:"post",
                url:"/restaurant/addCustomer",
