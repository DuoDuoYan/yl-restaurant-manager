$().ready(function() {
    ...
    //数据校验
    validator($('#addRobotForm'));
    validator($('#updateRobotForm'));
...
function init(){
    ...
    $('#dataTable').bootstrapTable({
        ...
        url : "/restaurant/findAllRobot", // 服务器数据的加载地址
        iconSize : 'outline',
...
function  btnFunction() {
    ...
    $('#addRobotBtn').click(function () {
        var num = $('#addNum').val();
        //验证输入数据结果
        if($('#addRobotForm').data('bootstrapValidator').isValid()){
            $.ajax({
                type:"post",
                url:"/restaurant/addRobot",
                data: {"num":num},
