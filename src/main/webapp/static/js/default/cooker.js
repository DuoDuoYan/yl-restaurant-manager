$().ready(function() {
    ...
    //数据校验
    validator($('#addCookerForm'));
    validator($('#updateCookerForm'));
...
function init(){
    ...
    $('#dataTable').bootstrapTable({
        ...
        url : "/restaurant/findAllCooker", // 服务器数据的加载地址
        iconSize : 'outline',
...
function  btnFunction() {
    ...
    $('#addCookerBtn').click(function () {
        ...
        //验证输入数据结果
        if($('#addCookerForm').data('bootstrapValidator').isValid()){
            $.ajax({
                method:"post",
                url:"/restaurant/addCooker",
    ...
    $('#updateCookerBtn').click(function () {
        ...
        $.ajax({
            ...
            data:{"phone":phone,"username":username,"password":password,"gender":gender,"age":age,"address":address,"originalPhone":originalPhone},
            success:function (result) {
                location.reload()  //刷新当前页面
            }
        })
